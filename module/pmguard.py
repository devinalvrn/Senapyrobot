...
from helper.pmpermitdb import get_approved_users, pm_guard
...
async def allow(client, message):
    ...
    await message.edit(f"**[Anda](tg://user?id={chat_id}) Sudah Saya Setujui Untuk Chat Private**")
...
@Client.on_message(filters.command(["unok", "dap", "disapprove", "dapp"], cmd) & filters.me & filters.private)
async def deny(client, message):
    chat_id = message.chat.id
    await Haku.deny_user(chat_id)
    await message.edit(f"**Maaf [BRO](tg://user?id={chat_id}) Pesanmu Saya Tolak.**")
